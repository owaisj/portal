...
export function applicationAddCtrl(window, angular, $, _) {
    ...
    angular.module('designsafe').controller('ApplicationAddCtrl',
        ['$scope', '$rootScope', '$q', '$timeout', '$uibModal', '$translate', '$state', 'Apps', 'AppsSimpleList', 'MultipleList', 'AppsWizard', 'Django', 'appCategories', 'appIcons', function($scope, $rootScope, $q, $timeout, $uibModal, $translate, $state, Apps, AppsSimpleList, MultipleList, AppsWizard, Django, appCategories, appIcons) {
            /** addForm form **/
            $scope.addSchema = {
                type: 'object',
                            ...
                            'items': [
                                {
                                    ...
                                    validatePath: function(event, form) {
                                        ...
                                        if (typeof $scope.model.deploymentSystem === 'undefined' || $scope.model.deploymentSystem === '') {
                                            let filePath = $scope.model.deploymentPath;
                                ...
                                },
                                {
                                    ...
                                    validatePath: function(event, form) {
                                        ...
                                        if (
                                            ...
                                            let filePath = $scope.model.deploymentPath + '/' + $scope.model.templatePath;
                                ...
                                },
                                {
                                    ...
                                    validatePath: function(event, form) {
                                        ...
                                        if (
                                            ...
                                            let filePath = $scope.model.deploymentPath + '/' + $scope.model.testPath;
                                            form.description = $scope.model.deploymentSystem + '/' + filePath + ' is not a valid path. Please check data browser and make sure it exists and you have permissions to it';
                                        } else {
                                            let filePath = $scope.model.deploymentPath + '/' + $scope.model.testPath;
                                            form.requesting = true;
                                                            ...
                                                            .then(
                                                                function(response) {
                                                                    ...
                                                                    var modalInstance = $uibModal.open({
                                                                        template: require('../html/application-add-success.html'),
                                                                        scope: $scope,
                                                                        size: 'md',
                                                                        resolve: {
                                                                            appMeta: function() {
